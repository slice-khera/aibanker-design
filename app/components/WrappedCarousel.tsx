...
export default function WrappedCarousel({
  ...
  const colorSchemes = [
    { bg: "from-indigo-600 via-purple-600 to-pink-600", accent: "from-pink-400 to-rose-500" },
    { bg: "from-slate-800 via-purple-900 to-indigo-950", accent: "from-blue-400 to-cyan-500" },
    { bg: "from-[#009837] via-teal-600 to-cyan-600", accent: "from-yellow-400 to-orange-500" },
    { bg: "from-rose-600 via-pink-600 to-fuchsia-600", accent: "from-amber-400 to-red-500" },
    { bg: "from-red-700 via-rose-700 to-pink-700", accent: "from-orange-400 to-red-500" },
    { bg: "from-violet-600 via-purple-600 to-fuchsia-600", accent: "from-cyan-400 to-blue-500" },
  ];
  ...
  return (
    <div className="relative flex h-full flex-col rounded-[24px] overflow-hidden bg-black">
      ...
      <style jsx>{`
        ...
        .animate-count-up { animation: count-up 1s cubic-bezier(0.34, 1.56, 0.64, 1); }
