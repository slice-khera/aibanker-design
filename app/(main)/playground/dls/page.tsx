...
const COLOR_GROUPS: { title: string; swatches: Swatch[] }[] = [
  {
    ...
    swatches: [
      ...
      { name: "VALENTINO_100", value: colors.VALENTINO_100 },
      { name: "VALENTINO_200", value: colors.VALENTINO_200 },
      { name: "VALENTINO_300", value: colors.VALENTINO_300 },
      ...
      { name: "VALENTINO_800", value: colors.VALENTINO_800 },
      { name: "VALENTINO_900", value: colors.VALENTINO_900 },
