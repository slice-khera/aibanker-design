...
export const AA_BENEFITS = [
  {
    title: "Deeper financial insights",
    subtitle: "See spending patterns across all your accounts, not just slice",
  },
  {
    title: "Personalized recommendations",
    subtitle: "Better data means better advice tailored to your life",
  },
  {
    title: "100% secure",
    subtitle: "RBI-regulated system. Your data is encrypted and consent-based.",
  },
];
...
export const BANKS = [
  ...
  { id: "icici", label: "ICICI Bank", initial: "I", color: "#F58220" },
  { id: "kotak", label: "Kotak", initial: "K", color: "#ED1C24" },
  { id: "sbi", label: "SBI", initial: "S", color: "#22409A" },
